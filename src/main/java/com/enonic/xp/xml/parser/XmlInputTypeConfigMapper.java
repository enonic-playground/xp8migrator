...
final class XmlInputTypeConfigMapper
{
    ...
    {
        final Function<String, String> aliasNamesFunction =
            com.enonic.xp.xml.parser.InputTypeAliasConverters.getConverter( inputTypeName )::convert;
        final Function<String, String> hyphenToCameNameFunction = com.enonic.xp.xml.parser.XmlInputTypeDefaultMapper::resolveName;
    ...
    {
        this.nameResolver = com.enonic.xp.xml.parser.XmlInputTypeDefaultMapper::resolveName;
