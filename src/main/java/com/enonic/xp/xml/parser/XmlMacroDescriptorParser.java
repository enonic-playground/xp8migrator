...
public final class XmlMacroDescriptorParser
    extends com.enonic.xp.xml.parser.XmlModelParser<XmlContentTypeParser>
{
        ...
        throws Exception
    {
        ...
        final com.enonic.xp.xml.parser.XmlFormMapper mapper = new XmlFormMapper( this.currentApplication );
