...
public final class XmlFormMapper
{
    ...
    private final com.enonic.xp.xml.parser.XmlInputTypeDefaultMapper defaultMapper;

    public XmlFormMapper( final ApplicationKey currentApplication )
    {
        this.currentApplication = currentApplication;
        this.defaultMapper = new com.enonic.xp.xml.parser.XmlInputTypeDefaultMapper();
    }
