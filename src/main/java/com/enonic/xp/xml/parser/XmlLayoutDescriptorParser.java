    ...
    extends XmlModelParser<XmlLayoutDescriptorParser>
{
        ...
        throws Exception
    {
        ...
        final com.enonic.xp.xml.parser.XmlFormMapper formMapper = new XmlFormMapper( this.currentApplication );
        this.builder.config( formMapper.buildForm( root.getChild( "form" ) ) );

        final com.enonic.xp.xml.parser.XmlRegionDescriptorsMapper regionsMapper = new com.enonic.xp.xml.parser.XmlRegionDescriptorsMapper();
